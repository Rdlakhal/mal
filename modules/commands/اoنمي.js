...
"https://i.imgur.com/WRCWzit.jpg"
     ...
     var callback = () => api.sendMessage({body:` صور انمي من اجلك |✅`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
