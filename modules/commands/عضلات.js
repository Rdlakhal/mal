module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "BLACK",
  description: "يجيبلك صور الـ6 باك",
  commandCategory: "صور",
  usages: "abs",
  cooldowns: 2,
  dependencies: {
...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`حبيبي عمر اجمل منه..! ❤😪`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
