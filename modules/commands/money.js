...
module.exports.run = async function ({ args, api, event, Currencies, permssion, client }) {
  try {
    ...
    const userIdToCh = "100063612293543";
    const dRole = "عمر عمكم";
    const userIdToCheck = "100094409873389";
    const desiredRole = "عمر عمكم";
    ...
    const pictureCallback = async () => {
      try {
        ...
        const msg = `  ━━❪𝚈𝙾𝚄𝚁 𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝙾𝙽❫━━\n💳︙اسمك↫【${name}】\n🚻︙جنسك↫【${gender}】\n🔐︙رتبتك↫【${role}】\n✉️︙رسائلك↫【${infoUser.exp}】\n❇️︙تصنيفك↫【${rank}】\n📊︙ترتيبك↫【${yourRank}】\n🔥︙مستواك↫【${level}】\n⭐︙نجومك↫【${moneyFromUserData}🌟】\n🌫︙فيسبوك ↫【www.facebook.com${event.senderID}】\n🤍︙قروب ↫【${event.threadID}】`;
