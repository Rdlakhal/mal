...
if ((event.body.toLowerCase() == "بحبكي") || (event.body.toLowerCase() =="بحبك" && event.senderID == "100094409873389")) {
 ...
 if ((event.body.toLowerCase() == "لا") || (event.body.toLowerCase() == "يس")) {
  ...
  if (event.body.indexOf("ملاك") == 0 || (event.body.indexOf("ملاكتي") == 0)) {
    var msg = {
      body: `${rand}`
    }
