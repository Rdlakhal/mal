...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/rankup/received_208072642380282.gif
`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/rankup/received_208072642380282.gif
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "╭──𖠺⃟꯭💎꯭⃟𖠺꯭꯭𖠺⃟꯭💎꯭⃟𖠺꯭꯭𖠺⃟꯭💎꯭⃟𖠺꯭꯭──╮\n{name}≥\n لقد أرتفع مستواك بالبوت وأصبح {level}╰──𖠺⃟꯭💎꯭⃟𖠺꯭꯭𖠺⃟꯭💎꯭⃟𖠺꯭꯭𖠺⃟꯭💎꯭⃟𖠺꯭꯭──╯\n",
	}
}
