module.exports.config = {
	...
	version: "1.0.1",
	hasPermssion: 0,
	credits: "الـفـخـم الـمـتـكـبــر ",
	description: "اجعل الروبوت يتكلم عبر النص",
	commandCategory: "العاب",
	usages: "[ru/en/ko/ja/ar] [Text]",
	cooldowns: 5,
	dependencies: {
		"path": "",
		"fs-extra": ""
...
module.exports.run = async function({ api, event, args }) {
	try {
		...
		var languageToSay = (["ru","en","ko","ja","ar"].some(item => content.indexOf(item) == 0)) ? content.slice(0, content.indexOf(" ")) : global.config.language;
